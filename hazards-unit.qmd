...
### Combined Safety Guidance

The following points combine the wording from the school farm resources and the existing safety documents already in this repo:

- Safety is critical in primary industries, and common hazards include vehicles, machinery, chemicals, and livestock.
- PPE stands for Personal Protective Equipment, and appropriate gear must be used for the task.
- Heavy lifting should use the legs, not the back, and ear protection is required when using loud machinery.
- Animals should be approached calmly, with a planned escape route and a clear understanding of animal welfare checks.
- Agricultural chemicals must be stored in labelled, secure containers; use PPE, keep a spill kit nearby, and keep chemicals away from feed and water.
- Tool maintenance, tidy work areas, and correct storage help reduce trips, cuts, and other farm hazards.
- A safety-first culture protects staff, students, animals, and the wider rural community, and it is essential for long-term farm success.
